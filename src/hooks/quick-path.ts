...
export const getBestPath = async (fromToken: string, toToken: string) => {
  ...
  return {
    array: findBestRoute.bestRouteQuote.routePathArray,
    text: findBestRoute.bestRouteQuote.routeText,
  };
};
